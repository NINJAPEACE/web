    ...
    return {
      ...
      slides: [
        ...
        { classes: "main-slide no-select", anim: "up", type: "normal", subtype: "main" },
        {
          ...
          heading: "I $am$",
          h3: "Who am I?",
          p: "A self-taught programmer and visual designer. I like to code and design, they coloured my life.",
          component: "resume"
        },
        {
        ...
        },
        {
          ...
          p: "• Opened a Coding Class for public\n• Hired on some small communities, around hundred to a thousand members.",
          component: "hire"
        },
